	...
	<div class="navigation">
		<span class="menu"></span> 
			<ul class="navig cl-effect-16">
			  ...
			  <li><a href="cart_details_view.jsp">Cart Details</a></li>
...
<%
ResultSet rs=stmt.executeQuery("select a.id,a.furniture_name,a.size,a.cost,b.pid,b.oid,b.status from product_details a,cart_details b where a.id=b.pid");

%>

  <table width="412" height="68" border="1" align="center">
    <tr>
      <td>Sl.no</td>
      <td>Product Name</td>
      <td>Quantity</td>
    ...
    <tr>
      ...
      <td><%=rs.getString(3)%></td>
      <td><a href="cart_details_del.jsp?id=<%=rs.getString(1)%>">Remove</a><span class="style2"></a></span></td>
    </tr>
  ...
  <p align="center" class="style5"><span class="style3">
