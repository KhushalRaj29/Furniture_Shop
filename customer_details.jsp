...
<form action="customer_insert.jsp" method="post">
  <p align="center" class="style3 style4 style4 style4">Customer Id: 
    <label>
    <input type="text" name="t1" id="t1"></label></p>
  <p align="center" class="style5 style4 style4">&nbsp;</p>
  <p align="center" class="style5 style4 style4">Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <input type="text" name="t2" id="t2"></p>
  <p align="center" class="style5 style4 style4">&nbsp;</p>
  <p align="center" class="style5 style4 style4">Address:&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
    <input type="text" name="t3" id="t3">
  </p>
  <p align="center" class="style5 style4 style4">&nbsp;</p>
  <p align="center" class="style5 style4 style4">Phone No:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
     <input type="text" name="t4" id="t4">
  </p>
  <p align="center" class="style5 style4 style4">&nbsp;</p>
  <p align="center" class="style5 style4 style4">Order Id:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <input type="text" name="t5" id="t5">
</p>
  <p align="center" class="style5 style4 style4">&nbsp;</p>
  <p align="center" class="style5 style4 style4"><span class="style3">
