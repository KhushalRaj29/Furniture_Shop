...
rs.next();
%>
		<table width="813" height="67" border="1" align="center">
  <tr>
    <td width="75"><strong>First Name</strong></td>
    <td width="74"><strong>Last Name</strong></td>
    <td width="49"><strong>Gender</strong></td>
    <td width="51"><strong>DOB</strong></td>
    <td width="52"><strong>State</strong></td>
    <td width="41"><strong>City</strong></td>
    <td width="52"><strong>Address</strong></td>
    <td width="49"><strong>Pincode</strong></td>
    <td width="49"><strong>Contact</strong></td>
