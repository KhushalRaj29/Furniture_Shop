...
int oid1=(Integer)session.getAttribute("oid1");

String pid=request.getParameter("p1");
ResultSet rs=stmt.executeQuery("select * from product_details where category='"+pid+"'");
...
<table width="499" border="1">
  <tr>
    <td width="176"><span class="style1"><%=rs.getString(2)%></span></td>
    <td width="120"><span class="style1">Cost</span></td>
    <td><span class="style1"><%=rs.getString(6)%></span></td>
    </tr>
  <tr>
    <td><img src="upload/<%=rs.getString(9)%>" width="100" height="100"></td>
    <td colspan="2"><%=rs.getString(7)%></td>
    </tr>
  <tr>
    <td><span class="style2"><a href="add_cart_details.jsp?uname=<%=uname%>&pid=<%=rs.getString(1)%>&oid=<%=oid1%>">ADD TO CART</a></span></td>
    <td><span class="style2"><a href="add_buy_details.jsp?uname=<%=uname%>&pid=<%=rs.getString(1)%>&oid=<%=oid1%>">Buy</a></span></td>
    <td><span class="style2"><a href="more_details.jsp?uname=<%=uname%>&pid=<%=rs.getString(1)%>&oid=<%=oid1%>">More details</a></span></td>
    </tr>
  <tr>
    <td colspan="3"><hr></td>
    </tr>
