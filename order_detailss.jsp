...
<form action="order_details_con.jsp" method="post" enctype="">
  <p align="center" class="style3 style4 style4">Customer Id:&nbsp;&nbsp; &nbsp;&nbsp; 
    <label> <input type="text" name="t1" id="t1"></label></p>
  <p align="center" class="style5 style4">&nbsp;</p>
  <p align="center" class="style5 style4">Order Id:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 
    <input type="text" name="t2" id="t2"></p>
  <p align="center" class="style5 style4">&nbsp;</p>
  <p align="center" class="style5 style4">Furniture Name:
    <input type="text" name="t3" id="t3"></p>
  <p align="center" class="style5 style4">&nbsp;</p>
  <p align="center" class="style5 style4">Cost :&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <input type="text" name="t4" id="t4">
  </p>
  <p align="center" class="style5 style4">&nbsp;</p>
  <p align="center" class="style5 style4"><span class="style3">
