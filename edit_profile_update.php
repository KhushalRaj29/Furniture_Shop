...
ResultSet rs=stmt.executeQuery("select * from  registration where email='"+uname+"'");
rs.next();
...
<form method="post" action="registeration_db.jsp">

	<td><div align="center">
	  <p>&nbsp;</p>
	  <p><strong><span class="style1"><span class="style3">*<span class="style2">Customer Name</span></span></span>:   
	      <input name="t1" type="text" id="t1" value="<%=rs.getString(2)%>">
	    </strong></p>
	</div>
	  <strong><label></label>
	</strong>
    ...
    <p align="center"><span class="style3">*</span><span class="style2">Last Name </span>:<strong>
    <input name="t2" type="text" id="t2" value="<%=rs.getString(3)%>">
    </strong></p>
<p align="center">&nbsp;</p>
<p align="center"><span class="style3">*</span><span class="style4"><strong>Address</strong></span> : 
  <label>
  <textarea name="t3" id="t3" cols="45" rows="5"><%=rs.getString(8)%>
  </textarea>
  </label>
</p>
<p align="center">&nbsp;</p>
<p align="center"><span class="style3">*</span><span class="style2">Phone no</span>:
  <label>
  <input name="t4" type="text" id="t4" value="<%=rs.getString(10)%>">
  </label>
</p>
<p align="center">&nbsp;</p>
<p align="center"><span class="style3">*</span><span class="style2">Pincode</span>:
  <input name="t5" type="text" id="t5" value="<%=rs.getString(9)%>">
</p>
<p align="center">&nbsp;</p>
<p align="center">
  <span class="style5">
