...
Integer oid1=(Integer)session.getAttribute("oid1");
...
//try
//{
ResultSet rs=stmt.executeQuery("select * from product_details where id="+pid+"");
rs.next();
...
<table width="652" height="219" border="1" align="center">
  <tr>
    <td width="187" rowspan="8"><div align="center"><img src="upload/<%=rs.getString(9)%>" width="100" height="100" > </div></td>
    <td width="266">Furniture Name</td>
    <td width="177"><%=rs.getString(3)%></td>
  </tr>
  <tr>
    <td>Used Wood</td>
