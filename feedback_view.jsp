...
%>
  ...
  <table width="412" height="68" border="1" align="center">
    <tr>
      ...
      <td>Price</td>
      <td>Total Prize</td>
      <td colspan="2"><div align="center">Activity</div></td>
    </tr>
    <%
	while(rs.next())
	{
    ...
    <tr>
      ...
      <td><%=rs.getString(3)%></td>
      <td><a href="cart_details_del.jsp?id=<%=rs.getString(1)%>">Remove</a></td>
      <td><span class="style2"><a href="cart_details_update.jsp?id=<%=id%>&pid=<%=rs.getString(1)%>&oid=<%=oid1%>">Confirm Order</a></span></td>
    </tr>
