...
rs.next();
%>
		<table width="497" height="56" border="1" align="center">
  <tr>
    <td width="94"><span class="style5">Custmer Id</span></td>
    <td width="97"><span class="style5">Order Id</span></td>
    <td width="130"><span class="style5">Furniture Name</span></td>
    <td width="77"><span class="style5">Cost</span></td>
  </tr>
  <% 
  while(rs.next())
  {
  %>
  <tr>
    <td><span class="style6"><%=rs.getString(1)%></span></td>
    <td><span class="style6"><%=rs.getString(2)%></span></td>
